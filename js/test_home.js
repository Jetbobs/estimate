...
$('.call_internet select[name="home_internetcall"]').on("change", function () {
...
//[call_wire]시작
//call_wire 셋팅
$('.call_wire select[name="home_wirecall"]').on("change", function () {
    call_wire = $(this).val();
    if (call_wire == 0) {
        [call_wire_price, call_wire_setup, call_wire_count, call_wire_sum, call_wire_setup_sum, call_wire_ea] = Array(6).fill(0);
    } else {
